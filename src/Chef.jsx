            ...
            <div className='col-md-4 p-3 my-3'>
                <div className='card'>
                    ...
                    <div className='card-footer text-center'>
                        ...
                        <h5 className='text-secondary'>Master Chef</h5>
                        ...
                        <h3 className='d-flex justify-content-center align-items-center '><i class="fa fa-facebook rounded px-2"></i><i class="fa fa-whatsapp rounded px-2"></i><i class="fa fa-twitter rounded px-2"></i><i class="fa fa-instagram rounded px-2"></i></h3>
                    </div>
                </div>
            </div>
            <div className='col-md-4 p-3 my-3'>
                <div className='card'>
                    ...
                    <div className='card-footer text-center'>
                        ...
                        <h5 className='text-secondary'>Pattisier</h5>
            ...
            <div className='col-md-4 p-3 my-3'>
                <div className='card'>
                    ...
                    <div className='card-footer text-center'>
                        ...
                        <h5 className='text-secondary'>Cook</h5>
